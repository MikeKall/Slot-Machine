...
namespace Slot_Machine
{
    public partial class Game3 : Form
    {
        ...
        private void SpinTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                GifFruit5.Visible = false;
                RandomImageSelection(Options.fruitsQuant, 5);
            }
            SpinCounter++;
        ...
        private void ImageCycleTimer_Tick(object sender, EventArgs e)
        {
            if (Options.fruitsQuant == 3)
            {
                if (CycleCounter == 0)
                {
                    ...
                    GifFruit5.Image = Properties.Resources.Watermelon;
                    CycleCounter++;
                }
                else if (CycleCounter == 1)
                {
                    ...
                    GifFruit5.Image = Properties.Resources.Cherries;
                    CycleCounter++;
                }
                else
                {
                    ...
                    GifFruit5.Image = Properties.Resources.Lemons;
                    CycleCounter = 0;
                }
            }
            else if (Options.fruitsQuant == 4)
            {
                ...
                else
                {
                    ...
                    GifFruit5.Image = Properties.Resources.Grapes;
                    CycleCounter = 0;
                }
            }
            else if (Options.fruitsQuant == 5)
            {
                ...
                else
                {
                    ...
                    GifFruit5.Image = Properties.Resources.Orange;
                    CycleCounter = 0;
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    GifFruit5.Image = Properties.Resources.Seven;
                    CycleCounter = 0;
                }
            }
        }
        ...
        private void RandomImageSelection(int fruits, int slot)
        {
            ...
            if (fruits == 3)
            {
                ...
                else if (slot == 5)
                {
                    ...
                    if (ImageSelect == 0)
                    {
                        Fruit5.Image = Properties.Resources.Cherries;
                        image5 = 0;
                    }
                    else if (ImageSelect == 1)
                    {
                        Fruit5.Image = Properties.Resources.Lemons;
                        image5 = 1;
                    }
                    else if (ImageSelect == 2)
                    {
                        Fruit5.Image = Properties.Resources.Watermelon;
                        image5 = 2;
                    }
                }
            }
            else if (fruits == 4)
            {
                ...
                else if (slot == 5)
                {
                    ...
                    {
                        Fruit5.Image = Properties.Resources.Grapes;
                        image5 = 3;
                    }
                }
            }
            else if (fruits == 5)
            {
                ...
                else if (slot == 5)
                {
                    ...
                    {
                        Fruit5.Image = Properties.Resources.Orange;
                        image5 = 4;
                    }
                }
            }
            else if (fruits == 6)
            {
                ...
                else if (slot == 5)
                {
                    ...
                    {
                        Fruit5.Image = Properties.Resources.Seven;
                        image5 = 5;
                    }
                }
            }
        ...
        {
            if (image1 == image2 && image2 == image3 && image3 == image4 && image4 == image5)//Win
            {
                Wallet += Bet;
                Walletbox.Text = Wallet.ToString();
